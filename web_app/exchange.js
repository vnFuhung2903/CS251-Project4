...
const exchange_name = 'TokenDealer';             // TODO: fill in the name of your exchange

const token_name = 'Allin';                // TODO: replace with name of your token
const token_symbol = 'ALN';              // TODO: replace with symbol for your token
...
const sanityCheck = async function() {
  ...
  if (Number(swap_fee[0]) == 0) {
      ...
      score += check("Test simple exchange of ETH to token", swap_fee[0],
